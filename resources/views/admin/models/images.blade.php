    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ $model->name }} - Şəkillər</h1>
                    </div>
                </div>
            </div>
        </div>
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    <div class="card-body">
                        <form action="{{ route('admin.model.image.store') }}" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                @csrf
